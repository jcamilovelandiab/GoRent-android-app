package com.app.gorent.ui.main;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        userRepository = UserRepository.getInstance(new DataSourceCache());
        ...
        mAppBarConfiguration = new AppBarConfiguration.Builder(
                R.id.nav_home, R.id.nav_search, R.id.nav_rent, R.id.nav_rented_items, R.id.nav_lend, R.id.nav_lent_items)
